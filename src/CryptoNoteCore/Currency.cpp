...
namespace CryptoNote {
	...
	difficulty_type Currency::nextDifficulty(
		...
		switch (blockMajorVersion) {
			case BLOCK_MAJOR_VERSION_4:
				logger(DEBUGGING, GREEN) << "Difficulty V4";
				return nextDifficultyV4(timestamps, cumulativeDifficulties);
				break;
			case BLOCK_MAJOR_VERSION_3:
				logger(DEBUGGING, BLUE) << "Difficulty V3";
				return nextDifficultyV3(timestamps, cumulativeDifficulties);
				break;
			case BLOCK_MAJOR_VERSION_2:
				logger(DEBUGGING, WHITE) << "Difficulty V2";
				return nextDifficultyV2(timestamps, cumulativeDifficulties);
				break;
			default:
				logger(DEBUGGING, YELLOW) << "Difficulty V1";
